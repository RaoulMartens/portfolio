...
const GALLERY_MAIN: GalleryItem[] = [
  ...
  { src: "/images/play/football-euros.webp", alt: "Abstract artwork of a football team celebrating on the field, with distorted red and blue glitch effects and players’ faces replaced by digital eye patterns." },
  { src: "/images/play/football-messi.webp", alt: "Lionel Messi in an Argentina jersey sits on a throne holding the World Cup trophy, surrounded by numerous golden Ballon d’Ors and championship cups under dramatic lighting." },
  { src: "/images/play/football-haaland.webp", alt: "Erling Haaland wearing a Manchester City jersey sits in a Viking ship holding a glowing blue axe, surrounded by footballs, sailing toward a burning castle under a stormy sky." },
...
const GALLERY_WIDE: GalleryItem[] = [
  { src: "/images/play/collabassa-ver.webp", alt: "View of a small Italian hillside village surrounded by dense green trees and mountains under a partly cloudy blue sky." },
  { src: "/images/play/utrecht-gebouw.webp", alt: "Street view of a large historic brick building with white trim in a European city, with a delivery van and pedestrians passing by under bright sunlight." },
];

const GALLERY_SQUARE: GalleryItem[] = [
  { src: "/images/play/kerk-plafond.webp", alt: "Ceiling of a Gothic-style church with detailed stone arches and colorful floral patterns painted between the ribs." },
  { src: "/images/play/poemba.webp", alt: "A cat sits on a mat by a sunlit door, gazing outside as warm light highlights its fur." },
  { src: "/images/play/boom-closeup.webp", alt: "Close-up of a large moss-covered tree trunk in a sunlit forest garden with green plants and yellow flowers around the base" },
  { src: "/images/play/toverland-paard.webp", alt: "Close-up of a large wooden Trojan horse sculpture decorated with metal shields and armor details." },
];

const GALLERY_MIX = {
  horizontal: { src: "/images/play/venlo-station.webp", alt: "A quiet street corner with a low beige building and two large green trees in front, lit by the warm evening sun." },
  vertical: { src: "/images/play/italie-bruggen.webp", alt: "View looking up between old connected buildings with arched bridges and worn shutters, showing a hanging towel and warm evening light." },
};

const GALLERY_VERTICALS: GalleryItem[] = [
  { src: "/images/play/antwerpen-tram.webp", alt: "Historic tram number 7 passing in front of the ornate Nationale Bank van België building on a sunny day in Antwerp." },
  { src: "/images/play/italie-uitzicht.webp", alt: "Moody mountain landscape with rolling green hills and soft clouds drifting across the peaks under a pale morning sky." },
  { src: "/images/play/breda-cathedraal.webp", alt: "Upward view of a tall Gothic church tower with intricate stone details and pointed arches, framed by a tree on the left under a cloudy sky." },
];

const GALLERY_SQ_WIDE = {
  square: { src: "/images/play/nina-sissy.webp", alt: "Black and white photo of an elderly woman sitting calmly on a bench beside a small dog, with stone walls and trees in the background." },
  horizontal: { src: "/images/play/rund-in-bos.webp", alt: "Black and white photo of a cow standing in a quiet forest clearing surrounded by tall, thin trees." },
};

const GALLERY_WIDE_2: GalleryItem[] = [
  { src: "/images/play/antwerpen-werk.webp", alt: "Black and white photo of a construction worker cutting metal beside tram tracks, with a large rusted pipe lying across the rails and pedestrians passing by in the background." },
  { src: "/images/play/friet-scootmobiel.webp", alt: "Black and white photo of people waiting in line at a food stand labeled ‘Verse Friet & Snacks,’ with an older person on a mobility scooter in the foreground." },
];
